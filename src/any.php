 ...
 * ```
 *
 * @param  callable $c Predicate function that tests each element. Receives a single
 ...
 * @return Closure  Returns a closure accepting an iterable and returning a boolean
