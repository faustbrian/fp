 ...
 * ```
 *
 * @see prepend() For adding values at the beginning of arrays
 * @see assoc() For setting values by key
 ...
 * @return Closure(array): array Returns a closure accepting an array and returning the modified
