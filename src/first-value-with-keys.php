 ...
 * ```
 *
 * @param  callable(mixed, array-key): mixed $c Transformation function that receives both the element value and
 *                                              its key from the iterable. Should return a truthy value to stop
 *                                              iteration and return that computed result, or a falsy value to
 *                                              continue searching through remaining elements.
 * @return Closure(iterable): mixed          Curried function that accepts an iterable and returns the first truthy result
