 ...
 * ```
 *
 * @param  callable(mixed): mixed   $c Transformation function that receives each element value from the iterable.
 *                                     Should return a truthy value to stop iteration and return that computed
 *                                     result, or a falsy value to continue searching through remaining elements.
