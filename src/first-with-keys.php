 ...
 * ```
 *
 * @param  callable(mixed, array-key): bool $c A predicate function that receives both the
 *                                             value and its key from the iterable. Should return
 *                                             true for the first element to be returned, false
 *                                             to continue searching.
 * @return Closure                          a function that accepts an iterable and returns the first element
