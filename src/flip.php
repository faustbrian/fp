 ...
 * waiting for the second argument. This enables "partial application from the right"
 * by allowing you to fix the second argument of the original function first.
 *
 * ```php
 * $subtract = fn($a, $b) => $a - $b;
 ...
 * ```
 *
 * @param  callable(mixed, mixed): mixed $fn Binary function expecting two arguments to be reversed
 * @return Closure                       Curried function accepting arguments in reverse order, supporting partial application
 *
 * @since 1.0.0
 */
