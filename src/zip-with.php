 ...
 * ```
 *
 * @param  callable(mixed ...): mixed                   $combiner Function that combines elements from corresponding positions.
 *                                                                Receives one argument per input array and returns the combined result.
 * @return Closure(array<mixed> ...): array<int, mixed> Returns a closure accepting variadic arrays and returning an array
